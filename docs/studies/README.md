...
| [Point- and shot-level sources](point_shot_sources/README.md) | Sources the dump does not use that hold point-by-point or shot-by-shot records of past matches, ranked by what they would fill in the same ten careers: SofaScore measured match by match and checked against its records, TennisLive.net sampled in SofaScore's gaps, Sackmann's old point strings and unexported Tennis Abstract charts linked, Grand Slam feeds and paid or private sources mapped from observed coverage and providers' claims |
